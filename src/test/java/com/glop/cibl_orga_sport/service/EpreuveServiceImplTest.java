...
class EpreuveServiceImplTest {
    ...
    void testCreateEpreuve() {
        ...
        Epreuve result = epreuveService.createEpreuve("100m nage libre", competition);
    ...
    void testUpdateEpreuve() {
        ...
        Epreuve result = epreuveService.updateEpreuve(1L, "200m nage libre", competition);
    ...
    void testUpdateEpreuve_NotFound() {
        ...
        Epreuve result = epreuveService.updateEpreuve(999L, "100m nage libre", null);
